...
size_t hash<alphazero::chess::Piece>::operator()(const alphazero::chess::Piece& p) const {
...
size_t hash<alphazero::chess::CastlingRights>::operator()(const alphazero::chess::CastlingRights& cr) const {
...
size_t hash<alphazero::go::StoneGroup>::operator()(const alphazero::go::StoneGroup& sg) const {
    size_t seed = 0;
